from data_loader_lda import get_data_loaders
import numpy as np
...
def main():
    ...
    train_loader, val_loader, test_loader = get_data_loaders(train_csv, val_csv, test_csv, feature_extraction='lda')
    ...
    classification_rep_rf = classification_report(y_test, rf_predictions, target_names=emotions)
    ...
    classification_rep = classification_report(y_test, knn_pred, target_names=emotions)
